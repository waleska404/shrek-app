...
import com.waleska404.shrek.ui.components.InfoBox
import com.waleska404.shrek.ui.components.OrderedList
import com.waleska404.shrek.ui.theme.EXPANDED_RADIUS_LEVEL
import com.waleska404.shrek.ui.theme.EXTRA_LARGE_PADDING
import com.waleska404.shrek.ui.theme.INFO_ICON_SIZE
import com.waleska404.shrek.ui.theme.LARGE_PADDING
import com.waleska404.shrek.ui.theme.MEDIUM_PADDING
import com.waleska404.shrek.ui.theme.MIN_SHEET_HEIGHT
import com.waleska404.shrek.ui.theme.SMALL_PADDING
import com.waleska404.shrek.util.Constants.ABOUT_TEXT_MAX_LINES
import com.waleska404.shrek.util.Constants.BASE_URL
import com.waleska404.shrek.util.Constants.MIN_BACKGROUND_IMAGE_HEIGHT
...
fun DetailsContent(
    ...
    selectedCharacter: ShrekCharacter?,
    ...
    Column(
        ...
        Row(
            ...
            InfoBox(
                ...
                bigText = "${selectedCharacter.power}",
            ...
            InfoBox(
                ...
                iconColor = infoBoxIconColor,
                bigText = selectedCharacter.month,
        ...
        Row(
            ...
            OrderedList(
                ...
                items = selectedCharacter.abilities,
                textColor = contentColor
            )
            OrderedList(
                title = stringResource(R.string.nature_types),
                items = selectedCharacter.natureTypes,
                textColor = contentColor
            )
        }
    }
...
fun BackgroundContent(
    ...
    val imageUrl = remember { "$BASE_URL${characterImage}" }
